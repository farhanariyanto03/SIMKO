...
public class form_komplain extends javax.swing.JFrame {
    ...
    public void datatable(){
        ...
        try{
            String sql = "SELECT tb_penghuni.id_penghuni, tb_penghuni.nama_penghuni, tb_kamar.noKamar, tb_komplain.jenis_komplain, tb_komplain.lama_keresahan, tb_komplain.permasalahan \n" +
                    ...
                    "ORDER BY tb_komplain.lama_keresahan DESC";
            java.sql.Connection conn = (Connection)config.configDB();
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover_navbarAdmin/tutupan.png"))); // NOI18N
        getContentPane().add(jLabel7);
        jLabel7.setBounds(248, 951, 126, 96);
        ...
        jLabel6.setBounds(1120, 180, 180, 110);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover_navbarAdmin/tutupan.png"))); // NOI18N
        getContentPane().add(jLabel8);
        jLabel8.setBounds(1080, 190, 100, 96);
    ...
    public void cariData(){
        ...
        try{
            String sql = "select * from tb_komplain where nama_penghuni like'%"+cari+"%' order by lama_keresahan DESC";
            java.sql.Connection conn = (Connection)config.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            while(res.next())

...
public class form_laporan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tanggal_akhir.setFont(new java.awt.Font("Microsoft Tai Le", 0, 18)); // NOI18N
        getContentPane().add(tanggal_akhir);
        tanggal_akhir.setBounds(700, 230, 160, 40);

        tanggal_awal.setFont(new java.awt.Font("Microsoft Tai Le", 0, 18)); // NOI18N
        getContentPane().add(tanggal_awal);
        tanggal_awal.setBounds(500, 230, 170, 40);
        ...
        lblnama5.setFont(new java.awt.Font("Microsoft Tai Le", 1, 24)); // NOI18N
        getContentPane().add(lblnama5);
        lblnama5.setBounds(1750, 40, 130, 40);
        ...
        opsi_cetak_panel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                opsi_cetak_panelMouseEntered(evt);
            }
        });
    ...
    private void btn_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cariActionPerformed
       try{
            ...
            ResultSet result = stm.executeQuery("SELECT tb_tagihan.id_tagihan, tb_kamar.harga, tb_penghuni.nama_penghuni, tb_tagihan.tgl_bayar,\n" +
"                        tb_tagihan.bayar, tb_tagihan.sisa, tb_tagihan.status, tb_tagihan.keterangan\n" +
"                        from tb_tagihan INNER JOIN tb_penghuni on tb_tagihan.id_penghuni = tb_penghuni.id_penghuni\n" +
"                        INNER JOIN tb_kamar on tb_tagihan.noKamar = tb_kamar.noKamar where tgl_bayar between  '"+tanggal1+"' and '"+tanggal2+"' and tb_tagihan.status = '"+combo_status.getSelectedItem()+"' ORDER BY tb_tagihan.tgl_bayar ASC");
            
            ResultSet result2 = stm2.executeQuery("SELECT tb_tagihan.id_tagihan, tb_kamar.harga, tb_penghuni.nama_penghuni, tb_tagihan.tgl_bayar,\n" +
"                        tb_tagihan.bayar, tb_tagihan.sisa, tb_tagihan.status, tb_tagihan.keterangan\n" +
"                        from tb_tagihan INNER JOIN tb_penghuni on tb_tagihan.id_penghuni = tb_penghuni.id_penghuni\n" +
"                        INNER JOIN tb_kamar on tb_tagihan.noKamar = tb_kamar.noKamar where tgl_bayar between  '"+tanggal1+"' and '"+tanggal2+"' ORDER BY tb_tagihan.tgl_bayar ASC");
          ...
          result2.close();
                ...
                ResultSet result3 = stm3.executeQuery("SELECT tb_tagihan.id_tagihan, tb_kamar.harga, tb_penghuni.nama_penghuni, tb_tagihan.tgl_bayar,\n" +
"                        tb_tagihan.bayar, tb_tagihan.sisa, tb_tagihan.status, tb_tagihan.keterangan\n" +
"                        from tb_tagihan INNER JOIN tb_penghuni on tb_tagihan.id_penghuni = tb_penghuni.id_penghuni\n" +
"                        INNER JOIN tb_kamar on tb_tagihan.noKamar = tb_kamar.noKamar where tb_tagihan.status = '"+combo_status.getSelectedItem()+"' ORDER BY tb_tagihan.tgl_bayar DESC");
    ...
    private void opsi_cetak_panelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_opsi_cetak_panelMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_opsi_cetak_panelMouseEntered

...
//                    txt_sisa.setText(rs.getString("sisa"));
    ...
    private void initComponents() {
        ...
        txt_tanggalbyr.setBounds(1380, 480, 370, 40);
        ...
        lblnama4_1.setFont(new java.awt.Font("Microsoft Tai Le", 1, 24)); // NOI18N
        ...
        jLabel1.setBounds(1470, 370, 41, 16);
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        ...
        try{
            String sql = "UPDATE tb_tagihan JOIN tb_penghuni ON tb_tagihan.id_penghuni = tb_penghuni.id_penghuni JOIN tb_kamar ON tb_tagihan.noKamar = tb_kamar.noKamar "
            ...
            JOptionPane.showMessageDialog(null, "Data gagal di edit, Mohon cek kembali data yang anda masukkan");
        }
    }

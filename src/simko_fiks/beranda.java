...
public class beranda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblnama.setFont(new java.awt.Font("Microsoft Tai Le", 1, 24)); // NOI18N
        getContentPane().add(lblnama, new org.netbeans.lib.awtextra.AbsoluteConstraints(1750, 40, 130, 40));

        lbladamin.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        lbladamin.setForeground(new java.awt.Color(0, 153, 153));
        lbladamin.setText(".");
        getContentPane().add(lbladamin, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 610, 300, 70));
...
//        this.dispose();
    ...
    public static final javax.swing.JLabel lbladamin = new javax.swing.JLabel();

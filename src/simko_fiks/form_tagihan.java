...
public class form_tagihan extends javax.swing.JFrame {
  ...
  private String status;
    ...
    public form_tagihan() {
        ...
        pop_up_kelebihanBayar.setVisible(false);
        pop_up_kelebihanBayar.setBackground(new Color(0,0,0,50));
    ...
    private void initComponents() {
        ...
        txt_tanggalbyr = new com.toedter.calendar.JDateChooser();
        ...
        pop_up_kelebihanBayar = new javax.swing.JPanel();
        ...
        txt_tanggalbyr.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        getContentPane().add(txt_tanggalbyr);
        txt_tanggalbyr.setBounds(1379, 470, 363, 58);
        ...
        btn_simpan.setBounds(1015, 878, 228, 58);
        ...
        lblnama4.setFont(new java.awt.Font("Microsoft Tai Le", 1, 24)); // NOI18N
        ...
        txt_id_bantu.setBounds(1710, 260, 41, 16);

        pop_up_kelebihanBayar.setBackground(new java.awt.Color(0, 0, 0));
        pop_up_kelebihanBayar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pop_up_kelebihanBayarMouseEntered(evt);
            }
        });
        pop_up_kelebihanBayar.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        pop_up_kelebihanBayar.add(btn_close1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1162, 429, 31, 31));
        ...
        pop_up_kelebihanBayar.add(btn_oke1, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 574, 120, 35));

        bg_simpan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pop up kelebihan.png"))); // NOI18N
        pop_up_kelebihanBayar.add(bg_simpan1, new org.netbeans.lib.awtextra.AbsoluteConstraints(704, 418, 511, 243));

        getContentPane().add(pop_up_kelebihanBayar);
        pop_up_kelebihanBayar.setBounds(0, 0, 1920, 1080);
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        ...
        try{
            ...
            String sql = "INSERT INTO tb_tagihan VALUES ('"+txt_id_transaksi.getText()+"','"+combo_idPeng.getSelectedItem()+"','"+txt_nokamar.getText()+"','"+tanggal+"','"+reFormat(txt_bayar.getText())+"','"+reFormat(txt_sisa.getText())+"','"+txt_status.getText()+"','"+txt_keterangan.getText()+"','"+txt_id_bantu.getText()+"')";
            ...
            JOptionPane.showMessageDialog(null, "Data gagal ditambahkan, Mohon cek kembali data yang anda masukkan");
        }
      }
...
//            txt_sisa.setText(String.valueOf(sisa));
            ...
            if (sisa > 0) {
                ...
                pop_up_kelebihanBayar.setVisible(true);
    ...
    private void pop_up_kelebihanBayarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pop_up_kelebihanBayarMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_pop_up_kelebihanBayarMouseEntered
    ...
    private javax.swing.JPanel pop_up_kelebihanBayar;
    ...
    private com.toedter.calendar.JDateChooser txt_tanggalbyr;

...
public class form_akunPenghuni extends javax.swing.JFrame {
    ...
    public void hapusOpsi(){
         try{
              ...
              ResultSet res = st.executeQuery("SELECT * FROM tb_penghuni JOIN tb_user ON tb_penghuni.id_penghuni = tb_user.id_penghuni where tb_user.id_penghuni = '"+cmb_idPeng.getSelectedItem()+"'");
              //cmb_idPeng.addItem("-- Pilih Kamar --");
              while(res.next()){
                    
                    cmb_idPeng.removeItem(res.getString("tb_penghuni.id_penghuni"));
                }
    ...
    public void tampil_idPenghuni(){
        ...
        while(res.next()){
            ...
            cmb_idPeng.addItem(res.getString("tb_penghuni.id_penghuni"));
        }
    ...
    public void hapus_idPenghuni(){
        try{
            ...
            ResultSet res = pst.executeQuery(sql);
            while(res.next()){
                cmb_idPeng.removeItem(res.getString("id_penghuni"));
            }  
        }catch (Exception e){
    ...
    private void initComponents() {
        ...
        tutupan = new javax.swing.JLabel();
        ...
        id_bantu = new javax.swing.JLabel();
        ...
        txt_nama.setBounds(1140, 266, 390, 50);
        ...
        txt_pass.setBounds(1140, 354, 390, 50);
        ...
        txt_pertanyaan.setBounds(650, 354, 400, 50);
        ...
        btn_simpan.setBounds(1111, 440, 181, 49);
        ...
        btn_reset.setBounds(895, 440, 181, 49);
        ...
        btn_edit.setBounds(519, 662, 129, 44);
        ...
        btn_hapus.setBounds(666, 662, 129, 44);
        ...
        lblnama7.setBounds(1750, 40, 130, 40);
        ...
        btn_kamarKost.setBounds(-35, 341, 353, 69);
        ...
        btn_penghuniKost.setBounds(-35, 412, 353, 69);
        ...
        tutupan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover_navbarAdmin/Rectangle 53.png"))); // NOI18N
        getContentPane().add(tutupan);
        tutupan.setBounds(0, 750, 300, 40);
        ...
        bg_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/popup_berhasilAkun.png"))); // NOI18N
        ...
        getContentPane().add(id_bantu);
        id_bantu.setBounds(0, 0, 0, 0);
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        try {
            ...
            String sql= "INSERT INTO tb_user VALUES ('"+cmb_idPeng.getSelectedItem()+"','"+txt_nama.getText()+"','"+txt_noKamar.getText()+"', '"+txt_pertanyaan.getText()+"','"+txt_pass.getText()+"',"
                    + " '"+id_bantu.getText()+"')";
            java.sql.Connection conn = (Connection)config.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
...
//            datatable();
    ...
    private void btn_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_editMouseClicked
        try{
            String sql = "UPDATE tb_user "
                    +"SET nama_penghuni ='"+txt_nama.getText()+"', pin = '"
    ...
    private void btn_oke1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_oke1MouseClicked
        ...
        pop_up_berhasilHapus.setVisible(false);
        this.dispose();
        new form_akunPenghuni().setVisible(true); //ini ngakalin harus dibenerin
    ...
    private void txt_namaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_namaFocusGained
        if(txt_nama.getText().equals("Masukkan Nama")){
            txt_nama.setText(null);
            txt_nama.requestFocus();
            removeplaceholderstyle(txt_nama);
        }
    ...
    private void tampil_id_bantu(){
        
         try{
            form_penghuni fp = new form_penghuni();
            fp.koneksi();
            String sql = "select id_bantu as a from tb_user order by id_bantu desc";
            ...
            if(rs.next()){
                ...
                id_bantu.setText(Integer.toString(a+1));
            }else{
    ...
    private javax.swing.JLabel id_bantu;
    ...
    private javax.swing.JLabel tutupan;

...
public class lupapassword1 extends javax.swing.JFrame {
    ...
    public lupapassword1() {
        ...
        pop_up_ubahPass.setBackground(new Color(0,0,0,50));
    }
    ...
    private void initComponents() {
        ...
        btn_batal.setBounds(664, 816, 284, 77);
        ...
        btn_ubah.setBounds(971, 816, 284, 77);
            ...
            JOptionPane.showMessageDialog(null, "nik tidak boleh kosong");  
                ...
                try{
                    ...
                    ResultSet rs = stm.executeQuery("select * from tb_login where nik = "+tf_username.getText()+"");
                        if(rs.next()){
                           try{
                               String sql = "update tb_login set passwords = '"+ tf_password.getText()+"' where nik = "+tf_username.getText()+"";

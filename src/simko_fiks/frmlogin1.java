...
import static simko_fiks.beranda.lbladamin;
import static simko_fiks.form_editTagihan.lblnama4_1;
import static simko_fiks.form_kamar.lblnama2;
import static simko_fiks.form_laporan.lblnama5;
import static simko_fiks.form_penghuni.lblnama3;
...
public class frmlogin1 extends javax.swing.JFrame {
    ...
    public frmlogin1() {
        ...
        pop_up_berhasilLogin.setVisible(false);
        pop_up_berhasilLogin.setBackground(new Color (0, 0, 0, 50));
    }
    ...
    private void initComponents() {
        ...
        pop_up_berhasilLogin = new javax.swing.JPanel();
        ...
        pop_up_berhasilLogin.setBackground(new java.awt.Color(0, 0, 0));
        pop_up_berhasilLogin.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        pop_up_berhasilLogin.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(1162, 429, 31, 31));
        ...
        pop_up_berhasilLogin.add(btn_oke, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 574, 120, 35));

        bg_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pop up berhasil login.png"))); // NOI18N
        pop_up_berhasilLogin.add(bg_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(704, 418, 511, 243));

        getContentPane().add(pop_up_berhasilLogin);
        pop_up_berhasilLogin.setBounds(0, 0, 1920, 1080);
...
//        new frmregister().setVisible(true);
    ...
    private void lblloginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblloginMouseClicked
        ...
        if(rs.next()){
                if(txtfusername.getText().equals(rs.getString("email"))
                    ...
                    lbladamin.setText(rs.getString(2));
                    lblnama2.setText(rs.getString(2));
                    lblnama3.setText(rs.getString(2));
    ...
    private javax.swing.JPanel pop_up_berhasilLogin;

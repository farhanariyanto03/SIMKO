...
import static simko_fiks.form_kamar.jTable1;
...
public class form_penghuni extends javax.swing.JFrame { 
    ...
    public form_penghuni() {
        ...
        tabelPenghuni.setSelectionBackground(new Color  (0,0,0));
        //=======================Setting Tabel Penghuni=======================//
        tabelPenghuni.getTableHeader().setFont(new Font("Microsoft Tai Le", Font.PLAIN, 28));
        tabelPenghuni.getTableHeader().setOpaque(false);
        tabelPenghuni.getTableHeader().setBackground(new Color(41, 80, 80));    
        tabelPenghuni.getTableHeader().setForeground(Color.white);
        tabelPenghuni.setSelectionBackground(new Color (105, 184, 184));      
        tabelPenghuni.setForeground(Color.white);
        tabelPenghuni.setSelectionForeground(Color.white);
        tabelPenghuni.setBackground(new Color (41, 141, 141));
        //====================Disable Tanggal di Masa Lalu====================//
        Date tgl = new Date();
        txt_tambah_tanggal.setMinSelectableDate(tgl);
        txt_tambah_tanggal.setDate(tgl);
        ...
        pop_up_konfirmasiHapus.setBackground(new Color(0,0,0,200));
        pop_up_batal.setBackground(new Color(0,0,0,200));
        //====================================================================//
...
//        }
    ...
    public void datatable(){
        ...
        try{
            String sql = "select id_penghuni, nama_penghuni, noKamar, tggl_masuk, alamat, tggl_keluar, no_telp from tb_penghuni order by id_bantu DESC";
            java.sql.Connection conn = (Connection)config.configDB();
    ...
    private void initComponents() {
        ...
        txt_tambah_tanggal = new com.toedter.calendar.JDateChooser();
        txt_tambah_keluar = new com.toedter.calendar.JDateChooser();
        ...
        txt_edit_tanggal = new com.toedter.calendar.JDateChooser();
        txt_edit_keluar = new com.toedter.calendar.JDateChooser();
        ...
        kosong_tambah_tanggal.setBounds(981, 610, 180, 25);

        txt_tambah_tanggal.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        panel_tambah.add(txt_tambah_tanggal);
        txt_tambah_tanggal.setBounds(981, 430, 445, 50);

        txt_tambah_keluar.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        panel_tambah.add(txt_tambah_keluar);
        txt_tambah_keluar.setBounds(981, 558, 445, 50);
        ...
        txt_tambah_id_bantu.setBounds(460, 230, 41, 16);
        ...
        pop_up_batal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pop_up_batalMouseEntered(evt);
            }
        });
        ...
        pop_up_konfirmasiHapus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pop_up_konfirmasiHapusMouseEntered(evt);
            }
        });
        ...
        txt_edit_harga.setEditable(false);
        ...
        kosong_edit_tanggal.setBounds(981, 610, 180, 25);

        txt_edit_tanggal.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        panel_edit.add(txt_edit_tanggal);
        txt_edit_tanggal.setBounds(981, 430, 445, 50);

        txt_edit_keluar.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        panel_edit.add(txt_edit_keluar);
        txt_edit_keluar.setBounds(981, 558, 445, 50);
        ...
        txt_edit_id_bantu.setBounds(410, 320, 41, 16);
        ...
        lblnama3.setFont(new java.awt.Font("Microsoft Tai Le", 1, 24)); // NOI18N
        getContentPane().add(lblnama3);
        lblnama3.setBounds(1750, 40, 130, 40);
        ...
        jLabel1.setBounds(280, 190, 41, 16);
    ...
    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
        ...
        if(klikedit == false){
            ...
            try{
                ...
                String no = tbl.getValueAt(i, 2).toString();
                cmb_tambah_kamar.addItem("-- Pilih Kamar --");
                cmb_edit_kamar.addItem(no); 
                cmb_edit_kamar.setSelectedItem(no); 
                while(res.next()){ 
    ...
    private void btn_simpan_tambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpan_tambahMouseClicked
       ...
       try {
        ...
        if(kosong_tanggal==true){
            ...
            java.sql.Connection conn = (Connection)config.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement("INSERT INTO tb_penghuni VALUES ('"+txt_tambah_kode_penghuni.getText()+"','"+txt_tambah_nama_penghuni.getText()+"','"+cmb_tambah_kamar.getSelectedItem()+"',"
            +"'"+tanggal+"', NULL, '"+txt_tambah_alamat.getText()+"','"+txt_tambah_no_telp.getText()+"','"+txt_tambah_id_bantu.getText()+"')");
            ...
            String sql= "INSERT INTO tb_penghuni VALUES ('"+txt_tambah_kode_penghuni.getText()+"','"+txt_tambah_nama_penghuni.getText()+"','"+cmb_tambah_kamar.getSelectedItem()+"',"
            +"'"+tanggal+"','"+keluar+"', '"+txt_tambah_alamat.getText()+"','"+txt_tambah_no_telp.getText()+"','"+txt_tambah_id_bantu.getText()+"')";
            java.sql.Connection conn = (Connection)config.configDB();
    ...
    private void btn_simpan_updateMouseClicked(java.awt.event.MouseEvent evt) {                                               
        ...
        if(kosong_tanggal==true){
            ...
            String sql = "UPDATE tb_penghuni "
                    + "SET nama_penghuni = '"+txt_edit_nama_penghuni.getText()+"', noKamar = '"
                    +cmb_edit_kamar.getSelectedItem()+"', tggl_masuk = '"+tanggal+"', tggl_keluar = NULL, alamat = '"
                    +txt_edit_alamat.getText()+"', no_telp = '"
                    +txt_edit_no_telp.getText()+"'WHERE tb_penghuni.id_penghuni = '"+txt_edit_kode_penghuni.getText()+"'";
...
//            txt_edit_harga.setText(res.getString("harga"));
            txt_edit_harga.setText(formatDec(res.getInt("harga")));
            }
    ...
    private void pop_up_konfirmasiHapusMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pop_up_konfirmasiHapusMouseEntered
        // TODO add your handling code here:

    }//GEN-LAST:event_pop_up_konfirmasiHapusMouseEntered

    private void pop_up_batalMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pop_up_batalMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_pop_up_batalMouseEntered
...
//        String harga = tbl.getValueAt(i, 7).toString();
       ...
       // else{
        ...
        if (txt_edit_harga == null){
            ...
            try{
                ...
                ResultSet result = st.executeQuery("select * from tb_penghuni join tb_kamar on tb_penghuni.noKamar = tb_kamar.noKamar where tb_kamar.noKamar = '"+cmb_edit_kamar.getSelectedItem()+"'");
                if (result.next()) {
                    txt_edit_harga.setText(result.getString("tb_kamar.harga"));
                }
    ...
    public static final javax.swing.JLabel lblnama3 = new javax.swing.JLabel();
    ...
    private com.toedter.calendar.JDateChooser txt_edit_keluar;
    ...
    private com.toedter.calendar.JDateChooser txt_edit_tanggal;
    ...
    private com.toedter.calendar.JDateChooser txt_tambah_keluar;
    ...
    private com.toedter.calendar.JDateChooser txt_tambah_tanggal;

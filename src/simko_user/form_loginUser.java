...
public class form_loginUser extends javax.swing.JFrame {
    ...
    public form_loginUser() {
        ...
        pop_upGagal.setVisible(false);
        pop_upGagal.setBackground(new Color (0, 0, 0, 50));
    }
    ...
    private void initComponents() {
        ...
        bg_loginUser = new javax.swing.JLabel();
        pop_upGagal = new javax.swing.JPanel();
        btnX = new javax.swing.JLabel();
        btn_oke = new javax.swing.JLabel();
        bg_pop_upBatal = new javax.swing.JLabel();
        ...
        lbllogin.setBounds(1294, 769, 270, 77);
        ...
        bg_loginUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/form_loginUser1.png"))); // NOI18N
        getContentPane().add(bg_loginUser);
        bg_loginUser.setBounds(0, 0, 1980, 1080);

        pop_upGagal.setBackground(new java.awt.Color(0, 0, 0));
        pop_upGagal.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        pop_upGagal.add(btnX, new org.netbeans.lib.awtextra.AbsoluteConstraints(1161, 429, 31, 31));
        ...
        pop_upGagal.add(btn_oke, new org.netbeans.lib.awtextra.AbsoluteConstraints(899, 575, 122, 35));

        bg_pop_upBatal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pop up gagal login.png"))); // NOI18N
        pop_upGagal.add(bg_pop_upBatal, new org.netbeans.lib.awtextra.AbsoluteConstraints(704, 418, -1, -1));

        getContentPane().add(pop_upGagal);
        pop_upGagal.setBounds(0, 0, 1920, 1080);
    ...
    private javax.swing.JLabel bg_loginUser;
    private javax.swing.JLabel bg_pop_upBatal;
    private javax.swing.JLabel btnX;
    private javax.swing.JLabel btn_oke;
    private javax.swing.JLabel hide;
    private javax.swing.JLabel lblLP;
    private javax.swing.JLabel lbllogin;
    private javax.swing.JPanel pop_upGagal;

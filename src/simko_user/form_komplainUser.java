...
public class form_komplainUser extends javax.swing.JFrame {
    ...
    public form_komplainUser() {
        ...
        Tampil_jam();
        Tampil_tanggal();
//        addplaceholderstyle(txt_lamaKeresahan);
        Date tgl = new Date();
        txt_lamaKeresahan.setDate(tgl);
        
        logout.setVisible(false);
        panel_berhasilKomplain.setVisible(false);
        logout.setBackground(new Color(0,0,0,200));
        panel_berhasilKomplain.setBackground(new Color(0,0,0,0));
    }
    ...
    private void initComponents() {
        ...
        panel_berhasilKomplain = new javax.swing.JPanel();
        btnx = new javax.swing.JLabel();
        btn_oke = new javax.swing.JLabel();
        bg_berhasilKomplain = new javax.swing.JLabel();
        cmb_keresahan = new javax.swing.JComboBox<>();
        cmb_jenisKomplain = new javax.swing.JComboBox<>();
        txt_lamaKeresahan = new com.toedter.calendar.JDateChooser();
        ...
        panel_berhasilKomplain.setBackground(new java.awt.Color(0, 0, 0));
        panel_berhasilKomplain.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                panel_berhasilKomplainMouseEntered(evt);
            }
        });
        panel_berhasilKomplain.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        panel_berhasilKomplain.add(btnx, new org.netbeans.lib.awtextra.AbsoluteConstraints(1162, 419, 31, 31));
        ...
        panel_berhasilKomplain.add(btn_oke, new org.netbeans.lib.awtextra.AbsoluteConstraints(899, 565, 122, 35));

        bg_berhasilKomplain.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pop up berhasil komplain.png"))); // NOI18N
        panel_berhasilKomplain.add(bg_berhasilKomplain, new org.netbeans.lib.awtextra.AbsoluteConstraints(704, 408, -1, -1));

        getContentPane().add(panel_berhasilKomplain);
        panel_berhasilKomplain.setBounds(0, 0, 1920, 1080);

        cmb_keresahan.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        getContentPane().add(cmb_keresahan);
        cmb_keresahan.setBounds(1090, 260, 350, 50);

        cmb_jenisKomplain.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        cmb_jenisKomplain.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih Jenis Komplain --", "Keamanan", "Fasilitas", "Kegaduhan" }));
        cmb_jenisKomplain.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_jenisKomplainActionPerformed(evt);
            }
        });
        getContentPane().add(cmb_jenisKomplain);
        cmb_jenisKomplain.setBounds(710, 260, 350, 50);

        txt_lamaKeresahan.setFont(new java.awt.Font("Microsoft Tai Le", 0, 24)); // NOI18N
        getContentPane().add(txt_lamaKeresahan);
        txt_lamaKeresahan.setBounds(1560, 620, 350, 50);
    ...
    private void btn_kirimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_kirimMouseClicked
        try{
            ...
            String tanggal = String.valueOf(fm.format(txt_lamaKeresahan.getDate()));
            
            String sql = "INSERT INTO tb_komplain VALUES ('"+form_loginUser.txtfkodePenghuni.getText()+"', '"+lbl_nama3.getText()+"', '"+lbl_noKamar.getText()+"', '"+cmb_jenisKomplain.getSelectedItem()+"', '"+tanggal+"', '"+txtf_permasalahan.getText()+"', 'Belum terbaca')";
            java.sql.Connection conn = (Connection)simko_fiks.config.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
            
            clear();
            panel_berhasilKomplain.setVisible(true);
    ...
    private void panel_berhasilKomplainMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panel_berhasilKomplainMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_panel_berhasilKomplainMouseEntered

    private void logoutMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_logoutMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_logoutMouseEntered

    private void cmb_jenisKomplainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_jenisKomplainActionPerformed
        // TODO add your handling code here:
        keresahan();
    }//GEN-LAST:event_cmb_jenisKomplainActionPerformed
    
    
    public void clear(){
        cmb_jenisKomplain.setSelectedIndex(0);
        txt_lamaKeresahan.setDate(null);
        txtf_permasalahan.setText(null);
    }
    
    
    public void keresahan(){

        int kom = cmb_jenisKomplain.getSelectedIndex();
            
        if(kom == 1){
            cmb_keresahan.removeAllItems();
            cmb_keresahan.addItem("Pilih Masalah Keamanan");
            cmb_keresahan.addItem("Kendaraan");
            cmb_keresahan.addItem("Barang");
            cmb_keresahan.addItem("Kamar");
            cmb_keresahan.addItem("Lain - Lain");
            
        }
        else if(kom == 2){
            cmb_keresahan.removeAllItems();
            cmb_keresahan.addItem("Pilih Fasilitas");
            cmb_keresahan.addItem("Kamar");
            cmb_keresahan.addItem("Kamar Mandi");
            cmb_keresahan.addItem("Lain - Lain");
        }
        else if(kom == 3){
            cmb_keresahan.removeAllItems();
            cmb_keresahan.addItem("Pilih Sumber Kegaduhan");
            cmb_keresahan.addItem("Pemilik Kos");
            cmb_keresahan.addItem("Penghuni Kos");
            cmb_keresahan.addItem("Luar Kos");
            cmb_keresahan.addItem("Lain - Lain");
        }
        else if(kom == 0){
            cmb_keresahan.removeAllItems();
    ...
    private javax.swing.JLabel bg_berhasilKomplain;
    ...
    private javax.swing.JComboBox<String> cmb_keresahan;
    ...
    private javax.swing.JPanel panel_berhasilKomplain;
    private javax.swing.JLabel tanggal_icon;
    private com.toedter.calendar.JDateChooser txt_lamaKeresahan;

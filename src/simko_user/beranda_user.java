...
public class beranda_user extends javax.swing.JFrame {
    ...
    public void jumlahtagihan(){
        try{
            ...
            ResultSet result = stm.executeQuery("select count(*) as jumlah from tb_history_tagihan where id_penghuni = '"+form_loginUser.txtfkodePenghuni.getText()+"'");
...
//                lbltotalpendapatan.setText(result.getString("jumlah"));
    ...
    private void initComponents() {
        ...
        lblnama.setBounds(1090, 570, 270, 60);
